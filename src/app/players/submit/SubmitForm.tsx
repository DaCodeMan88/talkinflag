      ...
      <div className="min-h-screen bg-brand-black pt-24 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-brand-white/60 mb-8 leading-relaxed">
            It&apos;s already linked to your account — head to your dashboard to keep editing it anytime.
            Our team reviews new profiles before they go public, usually within 48 hours.
          </p>
          <Link
            href="/dashboard"
    ...
    <div className="min-h-screen bg-brand-black pt-24 pb-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <div className="border-l-4 border-brand-yellow pl-6 mb-10">
          <h1 className="font-display text-5xl uppercase text-brand-white leading-none">Create Your Profile</h1>
          <p className="text-brand-white/50 mt-3 text-sm leading-relaxed">
            Get listed in the Talkin Flag player database. Visible to college coaches, scouts, and national team selectors worldwide. Free, always. This creates your own profile, linked to your account — reviewed before it goes public.
          </p>
        </div>
